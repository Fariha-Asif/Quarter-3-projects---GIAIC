import json  # yeh ek module hy data ko save or load krne k liye use hota hy
import os    # yeh file handling or system operation k liye use hota hy
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            print('Goodbye!')
            print('Thankyou for using personal library.')
            break
        else:
